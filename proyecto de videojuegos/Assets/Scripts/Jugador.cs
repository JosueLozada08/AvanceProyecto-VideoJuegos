...
public class Jugador : MonoBehaviour
{
    ...
    private  Vector2 posicionInicio;//pra que no de error al declararlo en la funcion updatre 


   // public Vector2 posicionTransicion = new Vector2(1.18f, -6.21f);
    ...
    void Start()
    {
        ...
        posicionInicio =  new Vector2(-3.65f, -5.41f);//inicializamos nuestro personaje en esta posicion 
    ...
    void VerificarPosicionTransicion()
    {
        ...
        // Verifica si el jugador ha llegado a la posición de transición
